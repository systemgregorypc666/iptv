 ...
 */
/**
 * This class supports validating Foundation form (https://foundation.zurb.com/)
 */
    ...
    FormValidation.Framework.Foundation = function(element, options) {
        options = $.extend(true, {
            button: {
                ...
                // https://foundation.zurb.com/docs/components/buttons.html#button-colors
                disabled: 'disabled'
            },
            err: {
                // https://foundation.zurb.com/docs/components/forms.html#error-states
                clazz: 'error',
            ...
            row: {
                // https://foundation.zurb.com/docs/components/forms.html
                selector: '.row',
